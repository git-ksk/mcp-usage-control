...
firestore_api_en = """## `mcp-usage-control-firestore`
...
replace_once(
    ...
    "See [Cloudflare adapter](cloudflare.md) for deployment and trust-boundary details.\n\n" + firestore_api_en + "## Numeric validation",
)
replace_once(
    "docs/api-reference.md",
    "- node-redis `redis` 6.2.x\n\nPre-1.0 minor releases",
...
firestore_api_ja = """## `mcp-usage-control-firestore`
...
replace_once(
    ...
    "詳細は [Cloudflare adapter](cloudflare.ja.md) を参照してください。\n\n" + firestore_api_ja + "## Numeric validation",
)
replace_once(
    "docs/api-reference.ja.md",
