...
**Current execution order:** **v0.8.0 is released and closed out.** The active product target is **v0.9.0 / #116-#127 safety hardening**, followed by **v0.10.0 / #76 + #82 + #99** operational usability and dogfood diagnostics, then **v0.11.0 / #24 + #6 + #105 + #106** final production/distribution evidence and API freeze, and finally **v1.0.0** as a feature-free stable promotion. No intermediate v0.8.1 release is required. The immediate Gateway dogfood mapping fix identified by #99 may land earlier as a consumer integration bugfix; #99's reusable contract/diagnostic work belongs to v0.10.0.
...
`v0.8.0` is released and closed out as the current source baseline. #81 is adopted as an optional scalar read-only future-v1 Store capability; **v0.9.0 / #116-#127 safety hardening is the active product decision target, followed by v0.10.0 / #76 + #82 + #99 operational usability**. Future tag/Release creation and npm publication remain separate operations.
